...
const TrainingManagement = () => {
  ...
  const handleCreateModule = () => {
    const module: TrainingModule = {
      ...
      maxParticipants: newModule.maxParticipants
        ? parseInt(newModule.maxParticipants)
        : undefined,
  ...
  const getAssignmentTargetName = (assignment: TrainingAssignment) => {
    switch (assignment.assignedType) {
      case "staff":
        return (
          staffMembers.find((s) => s.id === assignment.assignedTo)?.name ||
          assignment.assignedTo
        );
      case "team":
        return (
          teams.find((t) => t.id === assignment.assignedTo)?.name ||
          assignment.assignedTo
        );
      case "department":
        return (
          departments.find((d) => d.id === assignment.assignedTo)?.name ||
          assignment.assignedTo
        );
      default:
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Create training modules and assign to staff, teams, and
              departments
            </p>
          </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center gap-2">
                              ...
                              <span>
                                Max: {module.maxParticipants || "Unlimited"}
                              </span>
                            </div>
                            <div className="flex items-center gap-2">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-xl font-semibold">
                          {
                            trainingModules.filter((m) => m.status === "active")
                              .length
                          }
                        </span>
                      </div>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      {[
                        ...
                        const count = trainingModules.filter(
          ...
          <TabsContent value="assignments" className="space-y-6">
            <div className="grid gap-4">
              {assignments.map((assignment) => {
                const module = trainingModules.find(
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center gap-4 text-sm text-muted-foreground">
                            <span>
                              Assigned to:{" "}
                              <strong>
                                {getAssignmentTargetName(assignment)}
                              </strong>
                            </span>
                            <span>
                              Type:{" "}
        ...
        <Dialog open={isCreateModuleOpen} onOpenChange={setIsCreateModuleOpen}>
          <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Create a new training module to assign to staff, teams, or
                departments
              </DialogDescription>
            </DialogHeader>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewModule((prev) => ({ ...prev, level: value }))
                  }
                >
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewModule((prev) => ({ ...prev, format: value }))
                  }
                >
                  <SelectTrigger>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewAssignment((prev) => ({ ...prev, moduleId: value }))
                  }
                >
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={newAssignment.assignedType}
                  onValueChange={(value) =>
                    setNewAssignment((prev) => ({
                      ...prev,
                      assignedType: value as any,
                      assignedTo: "",
                    }))
                  }
                >
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewAssignment((prev) => ({ ...prev, assignedTo: value }))
                  }
                >
                  <SelectTrigger>
                  ...
                  <SelectContent>
                    {newAssignment.assignedType === "staff" &&
                      staffMembers.map((staff) => (
                        <SelectItem key={staff.id} value={staff.id}>
                          {staff.name} - {staff.position}
                        </SelectItem>
                      ))}
                    {newAssignment.assignedType === "team" &&
                      teams.map((team) => (
                        <SelectItem key={team.id} value={team.id}>
                          {team.name}
                        </SelectItem>
                      ))}
                    {newAssignment.assignedType === "department" &&
