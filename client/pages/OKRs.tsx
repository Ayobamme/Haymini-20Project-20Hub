...
const OKRs = () => {
  const [okrs, setOKRs] = useState<OKR[]>([
    {
      ...
      description:
        "Improve overall customer satisfaction scores and reduce churn rate for Q1 2024",
      type: "team",
      ...
      comments: [
        {
          ...
          author: "Admin User",
          content:
            "Great progress on the satisfaction score! Keep up the good work.",
    ...
    },
    {
      ...
      description:
        "Complete development of mobile application MVP with core features",
      type: "individual",
  ...
  const createOKR = () => {
    ...
    if (newOKR.type === "team") {
      ...
      const individual = availableIndividuals.find(
        (i) => i.email === newOKR.assignedTo,
      );
  ...
  const kpiData = {
    ...
    averageProgress: Math.round(
      okrs.reduce((sum, o) => sum + calculateOKRProgress(o), 0) / okrs.length,
    ),
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Create and track Objectives and Key Results for teams and
            individuals
          </p>
        </div>
        <Dialog open={showCreateOKR} onOpenChange={setShowCreateOKR}>
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="grid gap-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setNewOKR({ ...newOKR, priority: value as any })
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                            ...
                            >
                              ...
                              <Button
                                ...
                                onClick={() =>
                                  setNewKeyResult({
                                    ...newKeyResult,
                                    milestones: newKeyResult.milestones.filter(
                                      (_, i) => i !== index,
                                    ),
                                  })
                                }
              ...
              <TabsContent value="assignment" className="space-y-4 mt-6">
                <div className="grid gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Select
                      value={newOKR.assignedTo}
                      onValueChange={(value) =>
                        setNewOKR({ ...newOKR, assignedTo: value })
                      }
                    >
                      <SelectTrigger>
            ...
            <DialogFooter className="mt-6">
              ...
              <Button
                onClick={createOKR}
                disabled={!newOKR.title.trim() || !newOKR.assignedTo}
              >
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Progress tracking across all active OKRs
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Badge
                            variant="outline"
                            className={getPriorityColor(okr.priority)}
                          >
                            {okr.priority}
                          </Badge>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-20 bg-muted rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${(kpiData.activeOKRs / kpiData.totalOKRs) * 100}%`,
                          }}
                        />
                      </div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-20 bg-muted rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${(kpiData.teamOKRs / kpiData.totalOKRs) * 100}%`,
                          }}
                        />
                      </div>
                      <span className="text-sm font-medium">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-20 bg-muted rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${(kpiData.individualOKRs / kpiData.totalOKRs) * 100}%`,
                          }}
                        />
                      </div>
                      <span className="text-sm font-medium">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium text-green-600">
                        {
                          okrs.filter((o) => calculateOKRProgress(o) >= 70)
                            .length
                        }
                      </span>
                    </div>
                      ...
                      <span className="font-medium text-yellow-600">
                        {
                          okrs.filter(
                            (o) =>
                              calculateOKRProgress(o) >= 40 &&
                              calculateOKRProgress(o) < 70,
                          ).length
                        }
                      </span>
                    </div>
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium text-red-600">
                        {
                          okrs.filter((o) => calculateOKRProgress(o) < 40)
                            .length
                        }
                      </span>
                    </div>
              ...
              <DialogHeader>
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant="outline"
                      className={getPriorityColor(selectedOKR.priority)}
                    >
