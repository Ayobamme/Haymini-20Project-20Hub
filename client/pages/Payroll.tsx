...
const Payroll = () => {
  ...
  const [reportPeriod, setReportPeriod] = useState<"monthly" | "3month" | "6month" | "yearly">("monthly");
  ...
  const generateBulkReports = () => {
    const employeesToProcess = reportType === "all" ? employees : employees.filter(emp => selectedEmployees.includes(emp.id));
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Comprehensive payroll system with multi-period reporting and Google Drive integration
          </p>
        </div>
                  ...
                  <div>
                    ...
                    <Select value={reportType} onValueChange={(value) => setReportType(value as any)}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="individual">Selected Employees</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
                      ...
                      <div className="space-y-3">
                        {employees.map((employee) => (
                          <div key={employee.id} className="flex items-center space-x-2">
                            ...
                            />
                            <Label htmlFor={employee.id} className="flex items-center gap-2 cursor-pointer">
                ...
                <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      {reportType === "all" ? employees.length : selectedEmployees.length} employees • {reportPeriod} period
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="font-medium">
                      {reportType === "all" ? employees.length : selectedEmployees.length} reports
                    </div>
                    <div className="text-sm text-muted-foreground">will be generated</div>
                  </div>
                </div>
              </div>
              <DialogFooter>
                <Button variant="outline" onClick={() => setShowBulkReportDialog(false)}>
                  Cancel
                </Button>
          ...
          <Dialog open={showExportDialog} onOpenChange={setShowExportDialog}>
            ...
            <DialogContent>
              ...
              <div className="grid gap-4 py-4">
                ...
                <Separator />
                <Button onClick={archiveToGoogleDrive} className="justify-start" variant="outline">
        ...
        <TabsContent value="reports" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Generate comprehensive payroll reports and archive to Google Drive
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Button variant="outline" className="justify-start h-auto p-4" onClick={exportToGoogleSheets}>
                  <div className="text-left">
                    ...
                    <div className="text-sm text-muted-foreground">Live collaboration</div>
                  </div>
                </Button>

                <Button variant="outline" className="justify-start h-auto p-4" onClick={archiveToGoogleDrive}>
                  <div className="text-left">
                    <div className="font-medium">Google Drive</div>
                    <div className="text-sm text-muted-foreground">Archive documents</div>
                  </div>
                </Button>
